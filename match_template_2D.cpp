...
void MatchTemplateApp::DoInteractiveUserInput( ) {
    ...
    input_reconstruction        = my_input->GetFilenameFromUser("Input template stack", "The 3D stack of templates", "reconstruction.mrc", true);
    ...
    my_current_job.ManualSetArguments("ttffffffffffbffttttttttftiiiitttfbi", input_search_images.ToUTF8( ).data( ),
...
bool MatchTemplateApp::DoCalculation( ) {
    ...
    bool     ctf_refinement                  = my_current_job.arguments[13].ReturnBoolArgument( );
    float    particle_radius_angstroms       = my_current_job.arguments[14].ReturnFloatArgument( );
    float    phase_shift                     = my_current_job.arguments[15].ReturnFloatArgument( );
    wxString mip_output_file                 = my_current_job.arguments[16].ReturnStringArgument( );
    wxString best_psi_output_file            = my_current_job.arguments[17].ReturnStringArgument( );
    wxString best_theta_output_file          = my_current_job.arguments[18].ReturnStringArgument( );
    wxString best_phi_output_file            = my_current_job.arguments[19].ReturnStringArgument( );
    wxString best_defocus_output_file        = my_current_job.arguments[20].ReturnStringArgument( );
    wxString best_pixel_size_output_file     = my_current_job.arguments[21].ReturnStringArgument( );
    wxString scaled_mip_output_file          = my_current_job.arguments[22].ReturnStringArgument( );
    wxString correlation_avg_output_file     = my_current_job.arguments[23].ReturnStringArgument( );
    wxString my_symmetry                     = my_current_job.arguments[24].ReturnStringArgument( );
    float    in_plane_angular_step           = my_current_job.arguments[25].ReturnFloatArgument( );
    wxString output_histogram_file           = my_current_job.arguments[26].ReturnStringArgument( );
    ...
    wxString correlation_std_output_file     = my_current_job.arguments[31].ReturnStringArgument( );
    wxString directory_for_results           = my_current_job.arguments[32].ReturnStringArgument( );
    wxString result_output_filename          = my_current_job.arguments[33].ReturnStringArgument( );
    float    min_peak_radius                 = my_current_job.arguments[34].ReturnFloatArgument( );
    bool     use_gpu                         = my_current_job.arguments[35].ReturnBoolArgument( );
    int      max_threads                     = my_current_job.arguments[36].ReturnIntegerArgument( );
    ...
    if ( is_running_locally == true ) {
        ...
        //global_euler_search.number_of_search_positions - 1;
    }
    ...
    //  *= (2 * myroundint(float(defocus_search_range) / float(defocus_step)) + 1);
